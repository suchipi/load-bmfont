...
test(
  "should load JSON/ASCII even with binary true",
  run(
    {
...
test(
  "should load JSON/ASCII even with arraybuffer response",
  run(
    {
      uri: "fnt/Lato-Regular-32.json",
...
test(
  'should accept Node options and support "url" alias',
  run(
    {
      encoding: "ascii",
